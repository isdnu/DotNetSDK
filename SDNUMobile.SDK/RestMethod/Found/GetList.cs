...
namespace SDNUMobile.SDK.RestMethod.Found
{
    ...
    /// 公共失物招领列表获取方法
    /// </summary>
    public class GetList : AbstractRestMethod<FoundSummary[]>
    {
        #region 属性
        /// <summary>
        /// 获取方法路径
        ...
        public GetList(FoundObjectType type)
        {
            this.Type = type;
        }
        ...
        public GetList(Int32 pageSize, Int32 pageIndex)
        {
            this.Count = pageSize;
        ...
        /// <param name="pageSize">获取数量</param>
        /// <param name="pageIndex">页面索引</param>
        public GetList(FoundObjectType type, Int32 pageSize, Int32 pageIndex)
        {
            this.Type = type;
            this.Count = pageSize;
            this.Index = pageIndex;
